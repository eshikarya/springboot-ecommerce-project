...
//    private List<Category> categoryList = new ArrayList<>();
    ...
    //model mapper --- Java library that automatically maps objects from one type to another
    // 2 models: categoryDTO for presentation layer and category for database layer
    ...
    public CategoryDTO createCategory(CategoryDTO categoryDTO) {
        ...
        if(categoryInDB!=null) throw new APIException("Category with the name "+category.getCategoryName()+" already exists!!!");
